...
import { ConversationBlockCreateInput, VideoConversationCreateInput, VideoUpload, VideoUploadStorageLink } from '@trumpsaid/prisma';
...
export default class VideoTranscriber {
  ...
  public async recognize() {
    ...
    writeVideoUploadLog(this.video, 'STARTED', 'TRANSCRIPTION', null, moment().add(30, 'minutes'));
