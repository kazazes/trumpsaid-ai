...
export interface Query {
    ...
    publishedVideos: <T = PublishedVideo[]>(args: { where?: PublishedVideoWhereInput, orderBy?: PublishedVideoOrderByInput, skip?: Int, after?: String, before?: String, first?: Int, last?: Int }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T> ,
    ...
    publishedVideo: <T = PublishedVideo | null>(args: { where: PublishedVideoWhereUniqueInput }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T> ,
    ...
    publishedVideosConnection: <T = PublishedVideoConnection>(args: { where?: PublishedVideoWhereInput, orderBy?: PublishedVideoOrderByInput, skip?: Int, after?: String, before?: String, first?: Int, last?: Int }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T> ,
...
export interface Mutation {
    ...
    createPublishedVideo: <T = PublishedVideo>(args: { data: PublishedVideoCreateInput }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T> ,
    ...
    updatePublishedVideo: <T = PublishedVideo | null>(args: { data: PublishedVideoUpdateInput, where: PublishedVideoWhereUniqueInput }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T> ,
    ...
    deletePublishedVideo: <T = PublishedVideo | null>(args: { where: PublishedVideoWhereUniqueInput }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T> ,
    ...
    upsertPublishedVideo: <T = PublishedVideo>(args: { where: PublishedVideoWhereUniqueInput, create: PublishedVideoCreateInput, update: PublishedVideoUpdateInput }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T> ,
    ...
    updateManyPublishedVideos: <T = BatchPayload>(args: { data: PublishedVideoUpdateInput, where?: PublishedVideoWhereInput }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T> ,
    ...
    deleteManyPublishedVideos: <T = BatchPayload>(args: { where?: PublishedVideoWhereInput }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T> ,
...
export interface Subscription {
    ...
    publishedVideo: <T = PublishedVideoSubscriptionPayload | null>(args: { where?: PublishedVideoSubscriptionWhereInput }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<AsyncIterator<T>> ,
...
export interface Exists {
  ...
  PublishedVideo: (where?: PublishedVideoWhereInput) => Promise<boolean>
...
type Mutation {
  ...
  createPublishedVideo(data: PublishedVideoCreateInput!): PublishedVideo!
  ...
  updatePublishedVideo(data: PublishedVideoUpdateInput!, where: PublishedVideoWhereUniqueInput!): PublishedVideo
  ...
  deletePublishedVideo(where: PublishedVideoWhereUniqueInput!): PublishedVideo
  ...
  upsertPublishedVideo(where: PublishedVideoWhereUniqueInput!, create: PublishedVideoCreateInput!, update: PublishedVideoUpdateInput!): PublishedVideo!
  ...
  updateManyPublishedVideos(data: PublishedVideoUpdateInput!, where: PublishedVideoWhereInput): BatchPayload!
  ...
  deleteManyPublishedVideos(where: PublishedVideoWhereInput): BatchPayload!
...
type PublishedVideo implements Node {
  id: ID!
  ...
  speakers: Int!
  conversation(where: VideoConversationWhereInput): VideoConversation!
...
"""A connection to a list of items."""
type PublishedVideoConnection {
  """Information to aid in pagination."""
  pageInfo: PageInfo!

  """A list of edges."""
  edges: [PublishedVideoEdge]!
  aggregate: AggregatePublishedVideo!
}

input PublishedVideoCreateInput {
  slug: String
  title: String
  speakers: Int
  videoUpload: VideoUploadCreateOneInput!
  storageLinks: VideoUploadStorageLinkCreateManyInput
  dateRecorded: DateCreateOneInput
  conversation: VideoConversationCreateOneInput!
  newsSources: NewsSourceItemCreateManyInput
}

input PublishedVideoCreateOneInput {
  create: PublishedVideoCreateInput
  connect: PublishedVideoWhereUniqueInput
}

"""An edge in a connection."""
type PublishedVideoEdge {
  """The item at the end of the edge."""
  node: PublishedVideo!
...
enum PublishedVideoOrderByInput {
  id_ASC
  id_DESC
  createdAt_ASC
  createdAt_DESC
...
type PublishedVideoPreviousValues {
  id: ID!
  createdAt: DateTime!
  updatedAt: DateTime!
  slug: String
...
type PublishedVideoSubscriptionPayload {
  mutation: MutationType!
  node: PublishedVideo
  updatedFields: [String!]
  previousValues: PublishedVideoPreviousValues
}

input PublishedVideoSubscriptionWhereInput {
  """Logical AND on all given filters."""
  AND: [PublishedVideoSubscriptionWhereInput!]

  """Logical OR on all given filters."""
  OR: [PublishedVideoSubscriptionWhereInput!]

  """Logical NOT on all given filters combined by AND."""
  NOT: [PublishedVideoSubscriptionWhereInput!]
  ...
  """
  updatedFields_contains_some: [String!]
  node: PublishedVideoWhereInput
}

input PublishedVideoUpdateDataInput {
  slug: String
  title: String
  speakers: Int
  videoUpload: VideoUploadUpdateOneInput
  storageLinks: VideoUploadStorageLinkUpdateManyInput
  dateRecorded: DateUpdateOneInput
  conversation: VideoConversationUpdateOneInput
  newsSources: NewsSourceItemUpdateManyInput
}

input PublishedVideoUpdateInput {
  slug: String
  title: String
  speakers: Int
  videoUpload: VideoUploadUpdateOneInput
...
input PublishedVideoUpdateOneInput {
  create: PublishedVideoCreateInput
  connect: PublishedVideoWhereUniqueInput
  disconnect: Boolean
  delete: Boolean
  update: PublishedVideoUpdateDataInput
  upsert: PublishedVideoUpsertNestedInput
}

input PublishedVideoUpsertNestedInput {
  update: PublishedVideoUpdateDataInput!
  create: PublishedVideoCreateInput!
}

input PublishedVideoWhereInput {
  """Logical AND on all given filters."""
  AND: [PublishedVideoWhereInput!]

  """Logical OR on all given filters."""
  OR: [PublishedVideoWhereInput!]

  """Logical NOT on all given filters combined by AND."""
  NOT: [PublishedVideoWhereInput!]
  id: ID
  ...
  conversation: VideoConversationWhereInput
...
input PublishedVideoWhereUniqueInput {
  id: ID
  slug: String
  title: String
}
...
type Query {
  ...
  publishedVideos(where: PublishedVideoWhereInput, orderBy: PublishedVideoOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [PublishedVideo]!
  ...
  publishedVideo(where: PublishedVideoWhereUniqueInput!): PublishedVideo
  ...
  publishedVideosConnection(where: PublishedVideoWhereInput, orderBy: PublishedVideoOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): PublishedVideoConnection!
...
type Subscription {
  ...
  publishedVideo(where: PublishedVideoSubscriptionWhereInput): PublishedVideoSubscriptionPayload
...
input VideoConversationCreateOneInput {
  create: VideoConversationCreateInput
  connect: VideoConversationWhereUniqueInput
}
...
input VideoConversationUpdateOneInput {
  create: VideoConversationCreateInput
  connect: VideoConversationWhereUniqueInput
  delete: Boolean
  update: VideoConversationUpdateDataInput
  upsert: VideoConversationUpsertNestedInput
}
...
input VideoConversationUpsertNestedInput {
  update: VideoConversationUpdateDataInput!
  create: VideoConversationCreateInput!
}
...
type VideoUploadMetadata implements Node {
  ...
  published: Boolean!
  publishedVideo(where: PublishedVideoWhereInput): PublishedVideo
  speakers: Int!
  renderStart: Float!
  renderEnd: Float!
...
input VideoUploadMetadataCreateInput {
  ...
  publishedVideo: PublishedVideoCreateOneInput
...
input VideoUploadMetadataUpdateDataInput {
  ...
  publishedVideo: PublishedVideoUpdateOneInput
...
input VideoUploadMetadataWhereInput {
  ...
  publishedVideo: PublishedVideoWhereInput
...
input VideoUploadStorageLinkCreateManyInput {
  create: [VideoUploadStorageLinkCreateInput!]
...
input VideoUploadStorageLinkUpdateDataInput {
  path: String
  bucket: String
  version: VideoUploadFileLinkVersion
  fileType: VideoUploadFileLinkType
...
input VideoUploadStorageLinkUpdateManyInput {
  create: [VideoUploadStorageLinkCreateInput!]
  connect: [VideoUploadStorageLinkWhereUniqueInput!]
  disconnect: [VideoUploadStorageLinkWhereUniqueInput!]
  delete: [VideoUploadStorageLinkWhereUniqueInput!]
  update: [VideoUploadStorageLinkUpdateWithWhereUniqueNestedInput!]
  upsert: [VideoUploadStorageLinkUpsertWithWhereUniqueNestedInput!]
}
...
input VideoUploadStorageLinkUpdateWithWhereUniqueNestedInput {
  where: VideoUploadStorageLinkWhereUniqueInput!
  data: VideoUploadStorageLinkUpdateDataInput!
}
...
input VideoUploadStorageLinkUpsertWithWhereUniqueNestedInput {
  where: VideoUploadStorageLinkWhereUniqueInput!
  update: VideoUploadStorageLinkUpdateDataInput!
  create: VideoUploadStorageLinkCreateInput!
}
...
export type PublishedVideoOrderByInput =   'id_ASC' |
  'id_DESC' |
  'createdAt_ASC' |
  'createdAt_DESC' |
  'updatedAt_ASC' |
...
export interface PublishedVideoWhereInput {
  AND?: PublishedVideoWhereInput[] | PublishedVideoWhereInput
  OR?: PublishedVideoWhereInput[] | PublishedVideoWhereInput
...
export interface PublishedVideoSubscriptionWhereInput {
  AND?: PublishedVideoSubscriptionWhereInput[] | PublishedVideoSubscriptionWhereInput
  OR?: PublishedVideoSubscriptionWhereInput[] | PublishedVideoSubscriptionWhereInput
  NOT?: PublishedVideoSubscriptionWhereInput[] | PublishedVideoSubscriptionWhereInput
  mutation_in?: MutationType[] | MutationType
  updatedFields_contains?: String
  updatedFields_contains_every?: String[] | String
  updatedFields_contains_some?: String[] | String
...
export interface PublishedVideoCreateOneInput {
  create?: PublishedVideoCreateInput
  connect?: PublishedVideoWhereUniqueInput
}
...
export interface PublishedVideoCreateInput {
  slug?: String
  title?: String
  speakers?: Int
  videoUpload: VideoUploadCreateOneInput
...
export interface VideoUploadStorageLinkCreateManyInput {
  create?: VideoUploadStorageLinkCreateInput[] | VideoUploadStorageLinkCreateInput
  connect?: VideoUploadStorageLinkWhereUniqueInput[] | VideoUploadStorageLinkWhereUniqueInput
}
...
export interface PublishedVideoUpsertNestedInput {
  update: PublishedVideoUpdateDataInput
  create: PublishedVideoCreateInput
}
...
export interface VideoConversationCreateOneInput {
  create?: VideoConversationCreateInput
  connect?: VideoConversationWhereUniqueInput
}
...
export interface VideoUploadStorageLinkUpsertWithWhereUniqueNestedInput {
  where: VideoUploadStorageLinkWhereUniqueInput
  update: VideoUploadStorageLinkUpdateDataInput
  create: VideoUploadStorageLinkCreateInput
}
...
export interface VideoConversationUpdateOneInput {
  create?: VideoConversationCreateInput
  connect?: VideoConversationWhereUniqueInput
  delete?: Boolean
  update?: VideoConversationUpdateDataInput
...
export interface PublishedVideoUpdateOneInput {
  create?: PublishedVideoCreateInput
  connect?: PublishedVideoWhereUniqueInput
  disconnect?: Boolean
  delete?: Boolean
...
export interface PublishedVideoUpdateDataInput {
  slug?: String
  title?: String
  speakers?: Int
  videoUpload?: VideoUploadUpdateOneInput
...
export interface PublishedVideoUpdateInput {
  slug?: String
  title?: String
  speakers?: Int
  videoUpload?: VideoUploadUpdateOneInput
...
export interface VideoUploadStorageLinkUpdateManyInput {
  create?: VideoUploadStorageLinkCreateInput[] | VideoUploadStorageLinkCreateInput
  connect?: VideoUploadStorageLinkWhereUniqueInput[] | VideoUploadStorageLinkWhereUniqueInput
  disconnect?: VideoUploadStorageLinkWhereUniqueInput[] | VideoUploadStorageLinkWhereUniqueInput
  delete?: VideoUploadStorageLinkWhereUniqueInput[] | VideoUploadStorageLinkWhereUniqueInput
  update?: VideoUploadStorageLinkUpdateWithWhereUniqueNestedInput[] | VideoUploadStorageLinkUpdateWithWhereUniqueNestedInput
  upsert?: VideoUploadStorageLinkUpsertWithWhereUniqueNestedInput[] | VideoUploadStorageLinkUpsertWithWhereUniqueNestedInput
}
...
export interface VideoUploadStorageLinkUpdateDataInput {
  path?: String
  bucket?: String
  version?: VideoUploadFileLinkVersion
  fileType?: VideoUploadFileLinkType
...
export interface VideoUploadStorageLinkUpdateWithWhereUniqueNestedInput {
  where: VideoUploadStorageLinkWhereUniqueInput
  data: VideoUploadStorageLinkUpdateDataInput
}

export interface PublishedVideoWhereUniqueInput {
  id?: ID_Input
  slug?: String
  title?: String
}
...
export interface VideoConversationUpsertNestedInput {
  update: VideoConversationUpdateDataInput
  create: VideoConversationCreateInput
}
...
export interface AggregatePublishedVideo {
  count: Int
}
 ...
 */
export interface PublishedVideoConnection {
  pageInfo: PageInfo
  edges: PublishedVideoEdge[]
  aggregate: AggregatePublishedVideo
}
...
export interface PublishedVideoSubscriptionPayload {
  mutation: MutationType
  node?: PublishedVideo
  updatedFields?: String[]
  previousValues?: PublishedVideoPreviousValues
...
export interface PublishedVideoPreviousValues {
  id: ID_Output
  createdAt: DateTime
  updatedAt: DateTime
  slug?: String
...
export interface PublishedVideo extends Node {
  id: ID_Output
  videoUpload: VideoUpload
  createdAt: DateTime
  updatedAt: DateTime
 ...
 */
export interface PublishedVideoEdge {
  node: PublishedVideo
  cursor: String
}
